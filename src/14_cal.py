...
to print out a calendar for April in 2015,
...
argc = len(sys.argv)
if argc > 3:
    print('Too many arguments. Proper usage is "14_cal.py <month> <year>".')
elif argc == 3:
    ...
    month = int(sys.argv[1])
    print(calendar.TextCalendar(6).formatmonth(today.year, month))
else:
    print(calendar.TextCalendar(6).formatmonth(today.year, today.month))
